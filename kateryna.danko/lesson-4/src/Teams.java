...
public class Teams {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the first Team count:");
        double countTeam1 = Double.parseDouble(scanner.nextLine());


        System.out.println("Enter the second Team name:");
        String nameTeam2 = scanner.nextLine();

        System.out.println("Enter the second Team count:");
        double countTeam2 = Double.parseDouble(scanner.nextLine());
